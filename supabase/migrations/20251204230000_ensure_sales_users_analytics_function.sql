-- Ensure get_sales_users_with_analytics function exists with correct schema
...
IS 'Returns all sales users and admins with their performance analytics including picture_url for profile photos. Admin only.';
