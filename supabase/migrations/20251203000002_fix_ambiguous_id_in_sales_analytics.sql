-- Migration: Fix ambiguous column reference in get_sales_users_with_analytics
-- Description: Fixes "column reference 'id' is ambiguous" error by explicitly qualifying all column references
