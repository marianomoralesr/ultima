-- Fix email notification triggers with hardcoded configuration
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/jjepfehmuybpctdzipnu/sql/new
