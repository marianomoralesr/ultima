-- ============================================================================
-- DEBUG: Check if financing applications are visible
...
SELECT
    '============================================' as separator,
    'Compare TEST 1 (total in DB) with TEST 2 (visible to you)' as instruction,
    'If TEST 1 > 0 but TEST 2 = 0, RLS is still blocking' as meaning,
    '============================================' as separator2;
