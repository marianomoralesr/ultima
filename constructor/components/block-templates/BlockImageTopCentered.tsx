  ...
  return (
    <section ref={sectionRef} className="py-12 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{ backgroundColor: color }}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className={`max-w-2xl mx-auto text-lg text-slate-600 transition-all duration-700 ease-out delay-300 ${isAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          {paragraph}
        </p>
