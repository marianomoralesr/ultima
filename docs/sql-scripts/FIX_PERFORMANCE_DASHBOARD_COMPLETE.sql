-- ============================================================================
-- FIX COMPLETO: Dashboard de Performance - 3 funciones RPC
-- ============================================================================
-- Problema:
...
'[FIXED] Returns comprehensive performance metrics for a sales user. Fixed parameter name to p_sales_user_id and removed asesor_autorizado_acceso constraint.';
...
'[FIXED] Returns application counts grouped by status for a sales user. Fixed parameter name and removed asesor_autorizado_acceso constraint.';
...
'[FIXED] Returns detailed list of applications for a sales user with optional status filter. Fixed parameter names, removed asesor_autorizado_acceso constraint, and corrected document count query.';
...
SELECT
    '✅ Funciones del Performance Dashboard actualizadas:' as mensaje,
    routine_name,
