-- ============================================================================
-- FIX FINANCING APPLICATIONS RLS AND TRIGGER - RUN THIS IN SUPABASE SQL EDITOR
-- This fixes the RLS policies and trigger for financing_applications
...
FROM pg_trigger
WHERE tgrelid = 'public.financing_applications'::regclass
AND tgname = 'bi_set_user_id_financing_applications'

UNION ALL

SELECT
    '✅ Policy created' as status,
    policyname as trigger_name
FROM pg_policies
