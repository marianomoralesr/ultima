-- Migration: Remove non-existent deleted_at column references from get_sales_users_with_analytics
-- Description: financing_applications table does NOT have a deleted_at column - removing all references to it
