-- This script safely creates/updates the compras dashboard functions
...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'user_vehicles_for_sale' AND column_name = 'tags') THEN
        ALTER TABLE user_vehicles_for_sale ADD COLUMN tags jsonb DEFAULT '[]'::jsonb;
    END IF;
END $$;
