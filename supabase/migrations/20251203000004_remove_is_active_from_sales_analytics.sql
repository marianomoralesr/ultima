-- Migration: Remove non-existent is_active column from get_sales_users_with_analytics
-- Description: profiles table does NOT have an is_active column - removing it from the function
