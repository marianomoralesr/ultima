-- Fix get_secure_client_profile function by removing non-existent date_of_birth column
-- This was causing "column p.date_of_birth does not exist" error
...
BEGIN
    ...
    SELECT jsonb_build_object(
        'profile', jsonb_build_object(
            ...
            -- REMOVED: 'date_of_birth', p.date_of_birth,  (column doesn't exist)
            'curp', p.curp,
            'rfc', p.rfc,
            'address', p.address,
