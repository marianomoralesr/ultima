-- Final fix: Ensure get_sales_users_with_analytics function exists
-- This is a consolidated idempotent migration
...
IS 'Returns all sales users and admins with their performance analytics. Requires admin role.';
