...
color: cyan
Language: Spanish (all the following instructions should produce output in Spanish (MX))
---
...
- [ ] Is the documentation in Spanish? 
- [ ] Is the documentation using "Tú" instead of "Usted" when addressing users?
