-- ============================================================================
-- FIX BANK DASHBOARD - SUPPORT SPANISH STATUS VALUES
-- ============================================================================
-- Issue: Bank representatives can't see applications because query filters
-- for English status values but app uses Spanish status values
-- ============================================================================

-- Drop and recreate get_bank_rep_assigned_leads to support Spanish statuses
...
COMMENT ON FUNCTION get_bank_rep_assigned_leads IS 'Get all applications visible to a bank representative (supports Spanish and English status values)';
COMMENT ON FUNCTION get_bank_rep_dashboard_stats IS 'Get dashboard statistics for bank representative (supports Spanish and English status values)';
COMMENT ON FUNCTION get_bank_rep_lead_details IS 'Get detailed lead information (supports Spanish and English status values)';
